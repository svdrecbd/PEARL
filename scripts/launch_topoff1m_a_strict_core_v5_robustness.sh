...
RUN_NAME="pearl-topoff1m-a-strict-core-v5-stageb-lite-robustness-2phase-p12p24p48-t08-s41s53s67"
SUMMARY_PATH="$ROOT/reports/warmstart/pearl-micro-sft-topoff1m-a-strict-core-v5-stageb-lite-lr5e7-ep1/summary.json"
