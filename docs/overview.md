...
This first cleanup pass drew that line explicitly without rewriting the engine.

The current second pass does two concrete things:
- replaces the active strict and mining campaign wrappers with config-driven launchers under:

- [/Users/svdr/tinker/configs/experiments/README.md](/Users/svdr/tinker/configs/experiments/README.md)
- starts extracting reusable plumbing into:
...
The supported runner surface now uses those shared modules instead of reimplementing path, detached-job, and checkpoint logic per script.
