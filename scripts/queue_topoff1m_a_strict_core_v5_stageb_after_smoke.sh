...
SMOKE_SUMMARY="$ROOT/reports/robustness/pearl-topoff1m-a-strict-core-v5-stagea-smoke-p48-t08-s41s53s67/robustness_summary.json"
...
if python "$ROOT/scripts/evaluate_strict_core_smoke_gate.py" \
  ...
  bash "$ROOT/scripts/launch_topoff1m_a_strict_core_v5.sh" stage-b-lite
else
