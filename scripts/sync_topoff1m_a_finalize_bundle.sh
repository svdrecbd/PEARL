...
ssh -i "$SSH_KEY_PATH" "$REMOTE_USER@$HOST" \
  "mkdir -p '$REMOTE_ROOT/scripts' '$REMOTE_ROOT/data/petase_family_expanded' '$REMOTE_ROOT/reports/logs' '$REMOTE_ROOT/reports/raft' '$REMOTE_ROOT/venvs'"
...
rsync -av -e "ssh -i $SSH_KEY_PATH" \
  ...
  /Users/svdr/tinker/scripts/finalize_raft_wave.py \
  /Users/svdr/tinker/scripts/finalize_raft_wave_partition.py \
  /Users/svdr/tinker/scripts/launch_detached_job.py \
  /Users/svdr/tinker/scripts/launch_topoff1m_a_raft_finalize_partition.sh \
