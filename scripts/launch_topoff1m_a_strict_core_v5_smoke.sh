...
RUN_NAME="pearl-topoff1m-a-strict-core-v5-stagea-smoke-p48-t08-s41s53s67"
SUMMARY_PATH="$ROOT/reports/warmstart/pearl-micro-sft-topoff1m-a-strict-core-v5-stagea-lr1e6-ep3/summary.json"
