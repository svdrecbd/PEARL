...
5. Paid training normally runs through the campaign supervisor. A primary agent may use only the
   exact, prospectively versioned frontier local controllers after explicit user approval, a
