...
RUN_NAME="pearl-topoff1m-a-strict-core-v4-stageb-lite-robustness-2phase-p12p24p48-t08-s41s53s67"
SUMMARY_PATH="$ROOT/reports/warmstart/pearl-micro-sft-topoff1m-a-strict-core-v4-stageb-lite-lr5e7-ep1/summary.json"
PYTHON_BIN="${TINKER_PYTHON_BIN:-python}"
ESM_DEVICE="${ESM_DEVICE:-mps}"
